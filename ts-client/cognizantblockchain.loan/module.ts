...
export { MsgRepayLoan, MsgCancelLoan, MsgApproveLoan, MsgRequestLoan, MsgLiquidateLoan };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgRepayLoan({ value }: msgRepayLoanParams): EncodeObject {
			try {
				return { typeUrl: "/cognizantblockchain.loan.MsgRepayLoan", value: MsgRepayLoan.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCancelLoan({ value }: msgCancelLoanParams): EncodeObject {
			try {
				return { typeUrl: "/cognizantblockchain.loan.MsgCancelLoan", value: MsgCancelLoan.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgApproveLoan({ value }: msgApproveLoanParams): EncodeObject {
			try {
				return { typeUrl: "/cognizantblockchain.loan.MsgApproveLoan", value: MsgApproveLoan.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgRequestLoan({ value }: msgRequestLoanParams): EncodeObject {
			try {
				return { typeUrl: "/cognizantblockchain.loan.MsgRequestLoan", value: MsgRequestLoan.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgLiquidateLoan({ value }: msgLiquidateLoanParams): EncodeObject {
			try {
				return { typeUrl: "/cognizantblockchain.loan.MsgLiquidateLoan", value: MsgLiquidateLoan.fromPartial( value ) }  
			} catch (e: any) {
...
const Module = (test: IgniteClient) => {
	return {
		module: {
			CognizantblockchainLoan: new SDKModule(test)
		},
		registry: msgTypes
  }
}
