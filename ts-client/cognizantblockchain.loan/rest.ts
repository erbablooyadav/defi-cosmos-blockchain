...
export type LoanMsgCancelLoanResponse = object;
...
/**
 * @title cognizantblockchain/loan/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryLoanAll
   * @request GET:/cognizant-blockchain/loan/loan
   */
  queryLoanAll = (
    query?: {
    ...
    this.request<LoanQueryAllLoanResponse, RpcStatus>({
      path: `/cognizant-blockchain/loan/loan`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cognizant-blockchain/loan/loan/{id}
   */
  queryLoan = (id: string, params: RequestParams = {}) =>
    this.request<LoanQueryGetLoanResponse, RpcStatus>({
      path: `/cognizant-blockchain/loan/loan/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/cognizant-blockchain/loan/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LoanQueryParamsResponse, RpcStatus>({
      path: `/cognizant-blockchain/loan/params`,
      method: "GET",
      format: "json",
      ...params,
    });
