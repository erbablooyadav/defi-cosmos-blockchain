...
export default function useIbcApplicationsTransferV1() {
  ...
  const QueryDenomTraces = (query: any, options: any, perPage: number) => {
    ...
    return useInfiniteQuery([key], ({ pageParam = 1 }: { pageParam?: number }) => {
      ...
      ...options,
      // Modify the getNextPageParam and getPreviousPageParam functions
  ...
  return {
    QueryDenomTrace, QueryDenomTraces, QueryParams, QueryDenomHash, QueryEscrowAddress, QueryTotalEscrowForDenom,
  }
}