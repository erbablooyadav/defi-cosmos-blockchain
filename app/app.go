...
import (
	...
	loanmodule "cognizant-blockchain/x/loan"
	loanmodulekeeper "cognizant-blockchain/x/loan/keeper"
	loanmoduletypes "cognizant-blockchain/x/loan/types"
	mynftmodule "cognizant-blockchain/x/mynft"
	mynftmodulekeeper "cognizant-blockchain/x/mynft/keeper"
	mynftmoduletypes "cognizant-blockchain/x/mynft/types"

	// this line is used by starport scaffolding # stargate/app/moduleImport

	appparams "cognizant-blockchain/app/params"
	"cognizant-blockchain/docs"
)

const (
	AccountAddressPrefix = "cosmos"
	Name                 = "cognizant-blockchain"
)
...
func New(
	...
	*/
	...
	app.MynftKeeper = *mynftmodulekeeper.NewKeeper(
		appCodec,
		keys[mynftmoduletypes.StoreKey],
		keys[mynftmoduletypes.MemStoreKey],
		app.GetSubspace(mynftmoduletypes.ModuleName),
	)
	mynftModule := mynftmodule.NewAppModule(appCodec, app.MynftKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(mynftmoduletypes.ModuleName)
